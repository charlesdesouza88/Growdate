...
public class RecommendationServiceTests
{
    ...
    public async Task GetRecommendationsAsync_WithValidRegion_ReturnsRecommendations()
    {
        ...
        _mockRegionRepository.Setup(r => r.GetByIdAsync(1)).ReturnsAsync(region);
        _mockCropRepository.Setup(c => c.GetAllAsync()).ReturnsAsync(crops);
    ...
    {
        // Arrange
        _mockRegionRepository.Setup(r => r.GetByIdAsync(999)).ReturnsAsync((Region)null);
    ...
    public async Task GetDetailedRecommendationAsync_CalculatesCorrectHarvestDate()
    {
        ...
        _mockRegionRepository.Setup(r => r.GetByIdAsync(1)).ReturnsAsync(region);
        _mockCropRepository.Setup(c => c.GetByIdAsync(1)).ReturnsAsync(crop);
